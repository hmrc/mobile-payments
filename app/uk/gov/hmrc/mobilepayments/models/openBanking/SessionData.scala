...
import uk.gov.hmrc.mobilepayments.models.payapi.times.formats.MongoJavaTimeFormats
...
object SessionData {
  ...
  private def handleStringDate(stringDate: JsValue): JsResult[LocalDateTime] = {
